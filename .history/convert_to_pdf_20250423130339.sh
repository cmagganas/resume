...
INPUT_FILE="./files/resume.txt"
OUTPUT_FILE="./Christos_Magganas_Resume.pdf"

# Convert the text file to PDF using XeLaTeX with a different font
pandoc "$INPUT_FILE" -o "$OUTPUT_FILE" --pdf-engine=xelatex --variable mainfont="Arial" --variable geometry="margin=1in" --variable documentclass=article
